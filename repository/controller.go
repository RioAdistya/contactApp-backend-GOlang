...
import (
	...
	"github.com/RioAdistya/contactApp-go-react/database/models"
...
func (r *Repository) CreateUsers(context *fiber.Ctx) error {
	...
	if err := r.DB.Create(&user).Error; err != nil {
		return context.Status(fiber.StatusBadRequest).JSON(fiber.Map{"status": "error", "message": "couldn't create user", "data": err})
	}
